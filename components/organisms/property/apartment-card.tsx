    ...
    >
      <div className="relative overflow-hidden h-72">
        ...
        <button className="absolute top-4 right-4 p-2 bg-white/90 hover:bg-white rounded-full shadow-lg backdrop-blur-sm transition-all duration-300 hover:scale-110">
          <Heart className="h-4 w-4 text-slate-gray-600 hover:text-earth-yellow-500 transition-colors" />
        </button>
      </div>
      ...
      <CardContent className="p-6 space-y-4">
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center gap-1.5 bg-baby-powder-100 px-2 py-1 rounded-full">
            <Star className="h-4 w-4 fill-earth-yellow-500 text-earth-yellow-500" />
            <span className="text-sm font-semibold text-slate-gray-700">{apartment.rating}</span>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <MapPin className="h-4 w-4 text-glaucous-500" />
          <span className="text-slate-gray-600 font-medium">{apartment.location}</span>
        </div>
        ...
        <div className="flex justify-between items-center pt-2 border-t border-slate-gray-100">
          <div className="flex flex-col">
            <div className="flex items-baseline gap-1">
              <span className="text-3xl font-bold text-slate-gray-900">{apartment.price}</span>
              <span className="text-slate-gray-500 font-medium text-sm">/night</span>
            </div>
