...
export default function Properties() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-slate-gray-900 via-glaucous-900 to-slate-gray-800 text-white py-16 sm:py-20 md:py-24 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto z-10 px-4">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-slate-gray-200 leading-relaxed max-w-5xl drop-shadow-md">
      ...
      {/* Main Content */}
      <div className="bg-gradient-to-b from-white to-slate-gray-50 py-8 sm:py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="relative mb-4 sm:mb-6">
              ...
              <input
                ...
                className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-glaucous-500 transition-all duration-300 text-sm sm:text-base text-gray-700 placeholder-gray-400 shadow-sm"
              />
            </div>
            ...
            <button
              ...
              className="lg:hidden w-full flex items-center justify-center gap-2 bg-glaucous-600 hover:bg-glaucous-700 text-white py-3 px-6 rounded-xl font-semibold transition-all duration-300 mb-4 shadow-md text-sm sm:text-base"
            >
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mb-6 sm:mb-8">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-xl font-semibold transition-all duration-300 shadow-sm text-xs sm:text-sm md:text-base ${
                  selectedType === value
          ...
          {filteredProperties.length > 0 ? (
            ...
            <div className="text-center py-12 sm:py-16 px-4">
              ...
              <button
                onClick={clearFilters}
                className="inline-flex items-center gap-2 bg-glaucous-600 hover:bg-glaucous-700 text-white py-2.5 sm:py-3 px-6 sm:px-8 rounded-xl font-semibold transition-all duration-300 shadow-md text-sm sm:text-base"
              >
          ...
          {/* Call to Action */}
          <div className="mt-12 sm:mt-16 bg-gradient-to-br from-glaucous-600 to-slate-gray-800 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 text-center shadow-2xl">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-3 sm:mb-4 px-2">
              Can't Find What You're Looking For?
            </h2>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-gray-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a
                href="/contact-us"
                className="inline-flex items-center justify-center gap-2 bg-white text-glaucous-600 hover:bg-slate-gray-100 py-3 sm:py-4 px-6 sm:px-8 rounded-xl font-bold text-sm sm:text-base md:text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
              >
                Contact Us
              </a>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white hover:bg-[#20BD5A] py-3 sm:py-4 px-6 sm:px-8 rounded-xl font-bold text-sm sm:text-base md:text-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
              >
